...
mainelynx_NC_044304.1.NeAll<-read.table("/project/uma_lisa_komoroske/Tanya/scripts/SNeP/mainelynx/mainelynx_NC_044304.1.NeAll", header=TRUE)
mainelynx_NC_044305.1.NeAll<-read.table("/project/uma_lisa_komoroske/Tanya/scripts/SNeP/mainelynx/mainelynx_NC_044305.1.NeAll", header=TRUE)
mainelynx_NC_044306.1.NeAll<-read.table("/project/uma_lisa_komoroske/Tanya/scripts/SNeP/mainelynx/mainelynx_NC_044306.1.NeAll", header=TRUE)

#plotting mainelynx lines
lines(mainelynx_NC_044304.1.NeAll$Ne~mainelynx_NC_044304.1.NeAll$GenAgo, col=c("red") , lwd=1 , pch=19 , type="b") 
lines(mainelynx_NC_044305.1.NeAll$Ne~mainelynx_NC_044305.1.NeAll$GenAgo, col=c("yellow") , lwd=1 , pch=19 , type="b") 
lines(mainelynx_NC_044306.1.NeAll$Ne~mainelynx_NC_044306.1.NeAll$GenAgo, col=c("yellow") , lwd=1 , pch=19 , type="b") 
